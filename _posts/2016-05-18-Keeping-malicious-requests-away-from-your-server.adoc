= Keeping malicious requests away from your server
:keywords: fail2ban, firewall, ufw, active firewall, linux, shh, ssh-ddos, badbots, apache, nginx
"og:image": image::boosting-static.png[Boosting up statis files with Django]
